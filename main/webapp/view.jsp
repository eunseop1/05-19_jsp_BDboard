...
<%
	...
	if(boardVO==null){ // 글이 없다면? index로 이동
...
<body>
	<table>
		...
		<tr>
			...
			<!-- 혹시 누군가가 장난으로 태그를 이름에 같이 넣을 것을 방지 하기 위함 -->
			<td>IP</td>
		...
		<tr>
			...
			<%-- white-space를 사용하면 태그가 작동한다
			<td colspan="3"  style="text-align: left; white-space: pre-line;" >${vo.content }
			--%>
		...
		<tr>
			<td colspan="4" style="text-align: right;border: none;">
					...
					<!-- 누르는 순간 updateForm으로 이동한다 -->
						...
						<!-- 왜 false일까? 수정할때 조회수가 오르는 것을 방지하기 위함 -->				
					</c:url>
