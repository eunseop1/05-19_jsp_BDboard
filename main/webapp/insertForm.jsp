...
<form action="updateOk.jsp" method="post" onsubmit="return formCheck()">
	<table>
		<tr>
			<td class="title" colspan="4">게시판 새 글쓰기</td>
		</tr>
		<tr>
			<td> 이름</td>
			<td style="text-align: left;"> 
				<input type="text" name="name" id="name" required="required"/> 
				<%-- 여기에 보일 필요 없는 몇가지를 숨기자 --%>	
		...
		<tr>
			<td>제목</td>
			<td colspan="3" style="text-align: left"> <c:out value="${vo.subject }"/> 
